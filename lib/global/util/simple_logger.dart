...
class SimpleLogger extends LogPrinter {
  ...
  SimpleLogger({
    ...
    _topBorder = '$doubleDividerLine';
    _bottomBorder = '$doubleDividerLine';
  }
  ...
  bool _discardDeviceStacktraceLine(String line) {
    ...
    return match.group(2)!.contains('simple_logger') || match.group(2)!.startsWith('package:logger');
  }
  ...
  bool _discardWebStacktraceLine(String line) {
    ...
    return match.group(1)!.contains('simple_logger') ||
        match.group(1)!.startsWith('packages/logger') ||
  ...
  bool _discardBrowserStacktraceLine(String line) {
    ...
    return match.group(1)!.contains('simple_logger') ||
        match.group(1)!.startsWith('package:logger') ||
  ...
  List<String> _formatAndPrint(
    ...
    if (stacktrace != null) {
      // buffer.add('$color$verticalLine $stacktrace');
    ...
    for (var line in message.split('\n')) {
      buffer.add(color('$verticalLine [$time]$emoji$line'));
    }
